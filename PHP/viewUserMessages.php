...
<div class="container">
    <h2>View Messages</h2>
     <?php
      $sql= "SELECT username from messages ORDER BY sent_at DESC";
      $query=mysqli_query($conn,$sql);
      while($row=mysqli_fetch_array($query)){ ?>
        <div class="messages-section">
          <div class="message">
            <a href="seemessages.php?username=<?php echo $row['username'];?>" target="" rel="noopener noreferrer"><?php echo $row['username'];?></a>
          </div>
