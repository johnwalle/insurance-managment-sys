...
<body>
    ...
    <main>
        ...
        <div>
            <h2>2. Payment of Premiums</h2>
            <p>Members are required to pay an annual premium to maintain their health insurance coverage. Failure to make timely payments may result in the suspension or termination of benefits.</p>
        </div>
        ...
        <div>
            ...
            <p>Members can file claims for covered services by presenting their membership ID at participating healthcare facilities. Claims must be submitted within the specified timeframe and according to CBHI Gondar’s claims guidelines.</p>
        </div>
