...
<div class="container">
<h2><?php echo $lang == "en" ? "View Customer Messages" : "የደንበኞችን መልእክቶች ይመልከቱ"; ?></h2>
   <?php  
    $sql ="SELECT message, sent_at FROM message_from_user WHERE name ='$nameInput'  ORDER BY sent_at DESC";
